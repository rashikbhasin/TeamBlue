...
public class Read_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button submit=(Button)findViewById(R.id.read);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String serverURL="http://192.168.0.113:8080/read";
                new Reading().execute(serverURL);
            }
        });

    }

    protected class Reading extends AsyncTask<String,Void,Void>
    {
