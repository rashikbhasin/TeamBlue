...
public class Delete_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button submit=(Button)findViewById(R.id.delete);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try
                {
                    json.put("event_id",text.getText().toString());
                }
                catch(JSONException e) {
                    e.printStackTrace();
                }

                String serverURL="http://192.168.0.113:8080/delete";
                new Deleting().execute(serverURL);
            }
        });

    }

    protected class Deleting extends AsyncTask<String,Void,Void>
    {
